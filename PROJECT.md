...
src/                            # Source assets (committed)
  ...
  assets/                       # External installable assets: NickelMenu, KOReader, Readerly
  favicon/
...
This downloads NickelMenu, KOReader, and Readerly assets into `src/assets/`. Each asset is skipped if already present; pass `--force` to `tools/installables/setup.sh` to re-download all.
