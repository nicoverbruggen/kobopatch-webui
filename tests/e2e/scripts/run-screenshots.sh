...
#
# Output: screenshots/{mobile,desktop}/{manual-nickelmenu,manual-patches,connected-nickelmenu,connected-nickelmenu-removal,connected-patches,edge-cases}/*.png (gitignored)
