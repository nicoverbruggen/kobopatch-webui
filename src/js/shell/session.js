...
export class Session {
     ...
     *
     * Called from the constructor and from nothing else in `src/` — it is the
     * initializer rather than a lifecycle operation. `resetDeviceContext` is the
     * only reset the running app performs.
     */
    reset() {
