/**
 * KoboDevice.js — `KoboDevice`, the File System Access wrapper for a connected Kobo.
 *
...
import { assertValidDevicePath, formatDevicePath } from './DevicePaths.js';
import { devicePathError, deviceWriteError, deviceWriteProbeError, isNotFoundError, isTypeMismatchError } from './DeviceErrors.js';
