/**
 * PatchListView.js — Rendering and filtering of the patch selection list.
 *
...
import { getPatchMeta, PATCH_CATEGORIES, OTHER_CATEGORY, PATCH_FILE_LABELS } from './PatchMetadata.js';
import { openPatchEditor } from './PatchEditor.js';
